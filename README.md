...
На Ретрансляторе переходим в "Транспорты Сокеты":
...
На клиенте настраивается раздел "Транспорт":
- Жмём на «Транспорты», после чего справа открорется вкладка «Подсистема Транспорты», в которой видим перечень Внешних хостов  
...
На Клиенте в разделе "Интерфейсы Пользователя"  
- Убираем галочки "Запуск" (слева вверху) и "Начать опрос" (справа внизу). Чтобы мочь редактировать все поля настроек.
...
- В выпадающем списке "Сприсок проектов" жмём и выбираем "AGLKS" 
- Проставляем галочки "Запуск" (слева вверху) и "Начать опрос" (справа внизу)
