...
// MFCAllControlsApp.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCAllControlsAppApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CMFCAllControlsAppApp

CMFCAllControlsAppApp::CMFCAllControlsAppApp()
{
...
// Единственный объект CMFCAllControlsAppApp

CMFCAllControlsAppApp theApp;


// инициализация CMFCAllControlsAppApp

BOOL CMFCAllControlsAppApp::InitInstance()
{
